...
class GameView:
    ...
    def draw(self, model):
        ...
        if state == "MENU":
            ...
            self.screen.blit(self.general_bg, (0, 0))
            join_view.draw_await_join(self.screen, self.title_font, self.font, model.current_state.rects, model.ingr_id, self.back_arrow_img, model.current_state.error_message)
        elif state == "PLAYING":
